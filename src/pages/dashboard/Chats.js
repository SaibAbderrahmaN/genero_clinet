...
const Chats = () => {
  ...
  useEffect(() => {
    ...
    const CurrentConversation = conversations.find(e => e.id === selectedChatId)
    if(CurrentConversation){
      dispatch(SetCurrentConversation({current_conversation : CurrentConversation}))
      dispatch(FetchCurrentMessages({messages:CurrentConversation.messages }))
    }
